...
public class CommPortIdentifier {
    ...
    /**
     * Obtains the <CODE>CommPortIdentifier</CODE> object corresponding to a port that has already been opened by the
     * application.
     *
     * @param port
    ...
    /**
     * Obtains a <CODE>CommPortIdentifier</CODE> object by using a port name. The port name may have been stored in
     * persistent storage by the application.
     *
     * @param portName
     ...
     * <LI><CODE>PORT_OWNERSHIP_REQUESTED</CODE>: If the application owns this port and is willing to give up ownership,
     * then it should call <CODE>close</CODE> now.
     * </UL>
     * The <CODE>ownershipChange</CODE> method of the listener registered using <CODE>addPortOwnershipListener</CODE>
     * will be called with one of the above events.
     *
     * @param listener
    ...
    /**
     * Non-Api method. Called when close() method is called on CommPort object. Required to set port owner to null and
     * propagate CommPortOwnership event.
     */
     ...
     *
     * @return boolean <CODE>true</CODE> if the port is owned by some application, <CODE>false</CODE> if the port is not
     *         owned.
     */
    ...
    /**
     * Opens the communications port using a <CODE>FileDescriptor</CODE> object on platforms that support this
     * technique.
     *
